...
<ul id="social_side_links">
  <li><a style="background-color: #00FF00;width: 130px;height: auto;color: white;font-size: 29px"   data-toggle="modal" data-target="#myModal1">Order Now</a></li>
...
<div class="container">
	...
	<i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:UASWEB1@gmail.com">UASWWEB1@GMAIL.COM</a>
	</div>
	<div class="col-md-6 w3_c">
	<i class="fa fa-phone" aria-hidden="true"></i> +62 856 76173xx
	</div>
...
<nav class="navbar navbar-default ">
  <div class="container">
    ...
    <div class="navbar-header">
     ...
     <h1><a class="navbar-brand" href="#">Fast Laundry</a></h1>
    </div>
...
<a href="#" data-toggle="modal" data-target="#myModal">Read More </a>
  <div class="modal video-modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModal">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">FastLaundry</h4>
        </div>
		...
		<div class="container">
			<div class="agile-contact-grids">
			     <h3>Contact</h3>
					...
					<div class="map-grid">
						<iframe src="https://www.google.com/maps/place/Margamulya,+Cikajang,+Kabupaten+Garut,+Jawa+Barat/@-7.3545611,107.7321134,14z/data=!3m1!4b1!4m5!3m4!1s0x2e68a147b07241ad:0x29091023ef86ee8c!8m2!3d-7.3592065!4d107.7488167" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		...
		<div class="container">
			<div class="list">
				<div class="col-md-3 wthree_fl">
					<a href="#">Fast Laundry</a>
					</div>
					
					
					<div class="col-md-3 wthree_fr">
					<h6>+62 856 76173xx</h6>
					<h6><a href="mailto:UASWEB1@gmail.com">UASWEB1@GMAIL.COM</a></h6>
					</div>
			</div>
		</div>
	</div>
...
<div class="copyright">
		<div class="container">
			<p>© <?php echo date('Y');?> Copyright by 18111303_Rd Karan Nugraha_TIFRP18CIDA_UASWEB1</p>
		</div>
</div>
